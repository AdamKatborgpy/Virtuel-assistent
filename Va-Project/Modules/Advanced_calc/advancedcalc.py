...
def cal():
  ...
  sign = raw_input("Sign --> ")
  num2 = int(raw_input("Last number --> "))
...
def sqr():
  ...
  answer = raw_input("Enter a number you want to find the square root of: ")
  def cals():
...
def deg():
  ...
  degr, nummer = raw_input("Enter cos, sin or tan and then the number: ").split()
  degr = degr.lower()
  import math
  if degr == "cos":
...
#Vector
def vector():
  decide = raw_input("Choose 'Vector projection', 'determinant' 'Vector degrees' or 'Dot product': ").lower()
...
# Derteminant
def det():
  a1, a2 = raw_input("Enter a1 and a2: ").split()
  b1, b2 = raw_input("Enter b1 and b2: ").split()
  a1 = int(a1)
  a2 = int(a2)
  b1 = int(b1)
  b2 = int(b2)
...
# Line slope
def calc():
  x, y = raw_input("Enter x and y coordinates: ").split()
  x2, y2 = raw_input("Enter the second x and y coordinates: ").split()
  ys = int(y2) - int(y)
  xs = int(x2) - int(x)
...
choice = raw_input("Enter here: ").lower()
